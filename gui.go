...
func refresh_globals(font_size int) {
	...
	GUI.RANGES_RO_FIELD_HEIGHT = FIELD_HEIGHT

	GUI.DISCRETE_FIELD_WIDTH = 17 * font_size
	...
	TOP_PANEL_WIDTH = 2*GUI.LABEL_WIDTH + PRODUCT_FIELD_WIDTH + TOP_PANEL_INTER_SPACER_WIDTH + 2*REPRINT_BUTTON_WIDTH + 4*BUTTON_MARGIN

	GROUP_WIDTH = TOP_SPACER_WIDTH + GUI.LABEL_WIDTH + DATA_SUBFIELD_WIDTH + DATA_UNIT_WIDTH + DATA_MARGIN + BTM_SPACER_WIDTH + 2*GUI.ERROR_MARGIN
	GROUP_HEIGHT = TOP_SPACER_HEIGHT +
		NUM_FIELDS*FIELD_HEIGHT + BTM_SPACER_HEIGHT

	RANGE_WIDTH = TOP_SPACER_WIDTH + 3*GUI.RANGES_RO_FIELD_WIDTH + 2*GUI.RANGES_RO_SPACER_WIDTH + GUI.RANGES_RO_PADDING
