...
func Refresh_globals(font_size int) {
	...
	GUI.SMOL_BUTTON_WIDTH = 7 * font_size
	...
	GUI.REPRINT_BUTTON_MARGIN_L = 2*GUI.LABEL_WIDTH + GUI.PRODUCT_FIELD_WIDTH + GUI.TOP_PANEL_INTER_SPACER_WIDTH - 2*GUI.SMOL_BUTTON_WIDTH - GUI.DISCRETE_FIELD_WIDTH - 2*BUTTON_MARGIN
	...
	WINDOW_HEIGHT = TOP_PANEL_HEIGHT + GUI.PRODUCT_FIELD_HEIGHT + GUI.TOP_SPACER_HEIGHT + GUI.GROUP_HEIGHT + GUI.GROUP_MARGIN + GUI.BTM_SPACER_HEIGHT + GUI.BUTTON_HEIGHT + GUI.EDIT_FIELD_HEIGHT + 2*GUI.PRODUCT_FIELD_HEIGHT + GUI.PRODUCT_FIELD_HEIGHT + WINDOW_FUDGE_MARGIN
